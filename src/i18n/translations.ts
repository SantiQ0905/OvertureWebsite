...
const es = {
  ...
  join: {
    ...
    contactTitle: '¿Te interesa unirte?',
    contactDesc: 'Llena el formulario y nosotros nos ponemos en contacto contigo.',
    contactCta: 'Llenar formulario',
  },
  notFound: {
    kicker: 'Check Engine',
...
const en: typeof es = {
  ...
  join: {
    ...
    contactDesc: "Fill out the form and we'll reach out to you.",
    contactCta: 'Fill out the form',
  },
  notFound: {
    kicker: 'Check Engine',
    title: 'Off Track',
